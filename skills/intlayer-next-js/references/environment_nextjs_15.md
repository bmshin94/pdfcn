...
<Question title="What are the different solutions available to internationalize a Next.js 15 app?">
...
It is what detects the visitor's locale and redirects to the matching prefix, so you want it unless you handle locale routing yourself. Step 7 shows the configuration, including the matcher that keeps API routes, static assets and `_next` out of the way.
