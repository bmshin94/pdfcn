...
export const ReportLayout = ({
  ...
  return (
    <div data-pdf-document title={`${titlePrefix} ${data.period}`}>
      <div
        data-pdf-page="A4"
        style={({ ...styles.page, ...styles.pageBreak})}
      >
        <PageHeader
          variant="two-column"
          title={data.title}
        ...
        <Section variant="card" padding="md" noWrap>
          ...
          <div style={styles.metricsGrid}>
            {data.summary.map((metric) => (
              <div
                key={metric.label}
                style={({ ...styles.metricCard, borderLeftColor: metric.tone
      ...
      >
        ...
        >
          ...
          <div
            style={({ ...styles.graphShell, marginTop: graphVariant === "horizontal-bar" ? 34 : 0,
              position: "relative" as const,
